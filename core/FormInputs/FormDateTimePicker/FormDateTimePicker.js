...
var _default = props => {
  ...
  const baseProps = {
    ...
    fullWidth: true,
    format: _utils.dateTimeDisplayFormat,
  ...
  return _react.default.createElement(_pickers.DateTimePicker, _extends({}, baseProps, {
    value: value,
    labelFunc: (0, _utils.getDateTimeDisplayFuncFromProps)(props),
