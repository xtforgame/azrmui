...
var _default = props => {
  ...
  const baseProps = {
    ...
    fullWidth: true,
    format: _utils.dateDisplayFormat,
  ...
  return _react.default.createElement(_pickers.DatePicker, _extends({}, baseProps, {
    value: value,
    labelFunc: (0, _utils.getDateDisplayFuncFromProps)(props),
