...
var _NumberFormatInput = _interopRequireDefault(require("./NumberFormatInput"));
...
var _default = props => {
  ...
  if (currency) {
    InputProps.startAdornment = _react.default.createElement(_InputAdornment.default, {
      position: "start"
    }, "$");
  }

  InputProps = _objectSpread({}, InputProps, {}, IPs);
