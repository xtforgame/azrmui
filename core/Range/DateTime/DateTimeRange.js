...
var _default = props => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_FormInputs.FormDateTimePicker, _extends({
    ...
    variant: "content2"
  }), _react.default.createElement(_FormInputs.FormDateTimePicker, _extends({
    label: t('dateTimeEnd'),
    minutesStep: 60
