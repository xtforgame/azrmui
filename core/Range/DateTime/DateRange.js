...
var _default = props => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_FormInputs.FormDatePicker, _extends({
    label: t('dateStart')
    ...
    variant: "content2"
  }), _react.default.createElement(_FormInputs.FormDatePicker, _extends({
    label: t('dateEnd')
